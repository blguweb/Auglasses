...
def train(args, file_name, file_path, nw, device):
    path_label = '{}_pred{}_{}_{}_{}_tdo{}_cdo{}_im{}_au{}_ci{}_co{}_lr{}_pl{}_s{}_re{}_dm{}_nh{}_el{}_dl{}_dff{}_{}_{}_{}_{}.pkl'.format(
        args.time_run,
        args.pred_len,
        args.ear_type,
        args.lambda1,
    ...
    train_dataset = My_Dataset(path=file_path, label='train',data_type=args.ear_type)
    val_dataset = My_Dataset(path=file_path, label='val',data_type=args.ear_type)
    test_dataset = My_Dataset(path=file_path, label='test',data_type=args.ear_type)
